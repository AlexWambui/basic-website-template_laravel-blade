    ...
    <section class="userprofile">      
            ...
            <form action="{{ route('profile.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="image_input">
                    <div class="image" onclick="document.getElementById('image').click()">
                        @if($user->image)
                            <img id="previewImage" src="{{ asset('storage/user-images/' . $user->image) }}" alt="User" width="100" height="100">
                        @else
                            <img id="previewImage" src="{{ asset('assets/images/default-profile.webp') }}" alt="Default Profile Image" width="100" height="100">
                        @endif
                    </div>
                ...
                <div class="inputs_group">
                    ...
                    <div class="inputs">
                        ...
                        <input type="text" name="secondary_phone_number" id="secondary_phone_number" placeholder="Secondary Phone Number"
        ...
        <div class="custom_form">
            ...
            <form action="{{ route('password.update') }}" method="post">
                ...
                <div class="inputs">
                    <label for="update_password_current_password" class="required">Current Password</label>
                ...
                <div class="inputs">
                    <label for="update_password_password" class="required">New Password</label>
                ...
                <div class="inputs">
                    <label for="update_password_password_confirmation" class="required">Confirm Password</label>
